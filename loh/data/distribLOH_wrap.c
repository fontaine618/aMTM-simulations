...
#define SWIGTYPE_p_f_p_void_p_gsl_vector__double swig_types[0]
#define SWIGTYPE_p_gsl_vector swig_types[1]
...
static double (*gswig_const_distrib_LOH_cb)(void *,gsl_vector *) = (double (*)(void *ignore,gsl_vector *x))(distrib_LOH);
static SCM
_wrap_distrib_LOH_cb(SCM s_0)
{
#define FUNC_NAME "distrib-LOH-cb"
  SCM gswig_result;
  
  {
    gswig_result = SWIG_NewPointerObj (gswig_const_distrib_LOH_cb, SWIGTYPE_p_f_p_void_p_gsl_vector__double, 0);
  }
...
static SCM
_wrap_distrib_LOH (SCM s_0, SCM s_1)
{
#define FUNC_NAME "distrib-LOH"
  void *arg1 = (void *) 0 ;
  ...
  result = (double)distrib_LOH(arg1,arg2);
  {
...
SWIG_init(void)
{
  ...
  scm_c_define_gsubr("distrib-LOH-cb", 0, 0, 0, (swig_guile_proc) _wrap_distrib_LOH_cb);
  scm_c_define_gsubr("distrib-LOH", 2, 0, 0, (swig_guile_proc) _wrap_distrib_LOH);
}
...
/* Linkage: passive */
SCM
scm_init_distribLOH_module (void)
{
SWIG_init();
